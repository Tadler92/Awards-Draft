...
const barbie = {
  Globes: {
    'Best Musical/Comedy': 5,
    'Best Actress Musical/Comedy': 4,
    'Best Director': 4,
    'Best Supporting Actor': 3,
    'Best Screenplay': 2,
    'Best Original Song': (2 + 2 + 2),
  },
  Critics: {
    'Best Picture': 4,
    'Best Actress': 3,
...
const globesPoints = Object.values(barbie.Globes);
const globesNoms = Object.keys(barbie.Globes);
const criticsTbody = document.querySelector('#critics-table');
const criticsPoints = Object.values(barbie.Critics);
const criticsNoms = Object.keys(barbie.Critics);
