...
const globesPoints = Object.values(oppenheimer.Globes);
const globesNoms = Object.keys(oppenheimer.Globes);
const criticsTbody = document.querySelector('#critics-table');
const criticsPoints = Object.values(oppenheimer.Critics);
const criticsNoms = Object.keys(oppenheimer.Critics);
...
function putInfoOnPage() {
  ...
  globesCatTD7.innerText = `${globesNoms[5]}`;
  globesRow7.appendChild(globesCatTD7);
  globesNomTD7.innerText = `${globesPoints[5]} pts`;
