...
const globesPoints = Object.values(poorThings.Globes);
const globesNoms = Object.keys(poorThings.Globes);
const criticsTbody = document.querySelector('#critics-table');
const criticsPoints = Object.values(poorThings.Critics);
const criticsNoms = Object.keys(poorThings.Critics);
